...
class LoginAPI(MethodResource, Resource):
    ...
    def post(self, **kwargs):
        ...
        return LoginResponse().dump({'message': response['message']}), response['status_code'], {'Set-Cookie': 'token=' + response['session_id'] + '; Max-Age=3600' + '; Secure' + '; SameSite=None', 'Access-Control-Allow-Credentials': True}
